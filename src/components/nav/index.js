          ...
          <div className="flex items-center justify-between px-3 sm:px-6 py-3">
            ...
            <NavigationMenu className="hidden lg:flex">
              <NavigationMenuList className="space-x-1">
                <NavigationMenuItem>
                  <NavigationMenuLink
                    className="group inline-flex h-10 w-max items-center justify-center rounded-full px-4 py-2 text-sm font-medium transition-colors cursor-pointer text-gray-700 hover:bg-gray-100 hover:text-gray-900"
